...
\begin{frame}[fragile]
  ...
  \end{itemize}
  $$ p(x,n) = \left\{ \begin{array}{c l} 1 & \quad \text{ako je } n=0 \\x\cdot p(x, \frac{n-1}{2})^2 & \quad \text{ako je } n>0 \text{ neparan}\\p(x,n/2)^2 & \quad \text{ako je } n>0 \text{ paran} \end{array}\right. $$
  \begin{itemize}
    \item na primer: \\
